...
<head>
    ...
    <meta charset="utf-8">h, initial-scale=1">
...
<body class="clearfix">
                    ...
                    <div class="col l7 s13">
                        <div class="contact-right clearfix">
                            ...
                            <form action="engine.php" method="POST">
                                    ...
                                    <div class="cont-item phone" style="background-color: transparent;">
                                        ...
                                        <div class="cont-numbers">
                                            <div class="input-field">
                                                ...
                                                <textarea name="bodyDetails" rows="7" name="message"
                                ...
                                <input name="submit" id="scoreButton" type="submit"
    ...
    if($_POST['submit']==true){
        if ($conn->connect_error) {
          ...
          $sql = "INSERT INTO valuation_score (body, bodyDetails) where carNumberPlate = '$numPlate'
          VALUES ('$bodyScore', '$bodyDetails')";
